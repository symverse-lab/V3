# SymVerse V3 Command Line

> **Status:** Baseline import  
> **Date:** 2026-05-16  
> **Document Role:** Command-line reference carried into the SymVerse V3 documentation set and aligned to the `qsym` client name
...
$ qsym help
NAME:
   qsym - the quantum-symverse command line interface

   Copyright 2018-2019 The quantum-symverse Authors

USAGE:
   qsym [options] command [command options] [arguments...]
...
COMMANDS:
   ...
   bug               opens a window to report a bug on the qsym repo
...
LOGGING AND DEBUGGING OPTIONS:
  ...
  --logdir value            saving log as file type, value needs filepath. Default path is under the following path: /var/log/qsym/(day)/
